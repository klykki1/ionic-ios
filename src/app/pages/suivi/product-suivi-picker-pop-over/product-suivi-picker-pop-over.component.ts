...
@Component({
  ...
  templateUrl: './product-suivi-picker-pop-over.component.html',
  styleUrls: ['./product-suivi-picker-pop-over.component.scss'],
})
export class ProductSuiviPickerPopOverComponent implements OnInit {
  @Input() results: any;
  @Input() filtred: any;
  @Input() range: number;
  showSpinner = false;
